...
import { u as useCssTheme } from "./chunk-3fce2c11.js";
...
const SvgIcons = ({ color = "black", types, className }) => {
  ...
  let pathD = [
    ...
    { d01: 72.5869, d02: 100, d03: 798702e-11, d04: 100 },
  ...
  return /* @__PURE__ */ jsx(
    "svg",
    {
      ...
      children: calculateNewPathD(pathD, newSize / 200).map((pathCoords, index) => /* @__PURE__ */ jsx(
        "path",
        {
